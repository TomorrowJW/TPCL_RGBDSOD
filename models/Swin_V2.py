...
if __name__ == '__main__':
    ...
    swin.load_state_dict(torch.load('/home/jasonwu/1-projects/2-RGB-D/pre_train/swinv2_base_patch4_window16_256.pth')['model'],strict=False)
    features = swin(b)
    # print(len(features))
    print(features[0].shape) #[b,128,64,64]
    print(features[1].shape) #[b,256,32,32]
    print(features[2].shape) #[b,512,16,16]
    print(features[3].shape) #[b,1024,8,8]
    print(features[4].shape) #[b,1024,8,8]
    print(sum(p.numel() for p in swin.parameters()) / 1e6)